...
for (var i = 0; i < stadiums.length; i++) {
  ...
  L.marker((stadium.location), {icon: baseballIcon})
    .bindPopup("<h1>" + stadium.team + "</h1> <hr> <h3>Avg Ticket Price: " + stadium.price + "<p> Address:" + stadium.address + "<p> 2017 Season Record:" + stadium.record + "<p> World Series Wins:" + stadium.wins + "<br><img src=\"stadium_img\\" +
    stadium.img + ".jpg\">")
        .addTo(myMap);
}
