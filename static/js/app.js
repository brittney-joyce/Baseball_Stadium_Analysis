...
// Setting up width, height, and margins of graph
// Will also add room for label text and text padding
...
// xText transform property that places it at the bottom of the chart
...
xText
  .append("text")
  .attr("y", 0)
  .attr("data-name", "Attendance_2017")
  .attr("data-axis", "x")
...
yText
  .append("text")
  .attr("y", -26)
  .attr("data-name", "2017 Value")
  .attr("data-axis", "y")
  .attr("class", "aText active y")
  .text("Franchise Value (Millions)");

// Revenue
yText
  .append("text")
  .attr("x", 0)
  .attr("data-name", "2017 Revenue")
  .attr("data-axis", "y")
...
yText
  .append("text")
  .attr("y", 26)
  .attr("data-name", "2017 Operating Income")
  .attr("data-axis", "y")
  .attr("class", "aText inactive y")
...
d3.csv("static/data/Team_Data.csv", function(data) {
    // Visualize the data
    visualize(data);
  });
  ...
  function visualize(theData) {
    ...
    var curX = "Attendance_2017";
    var curY = "2017 Revenue";
    ...
    var toolTip = d3
      ...
      .html(function(d) {
        ...
        var theX;
        // Grab the state name.
        var theabbr = "<div>" + d.ABBR + "</div>";
        // Snatch the y value's key and value.
        var theY = "<div>" + curY + ": " + d[curY] + "%</div>";
        // If the x key is poverty
        if (curX === "Attendance_2017") {
